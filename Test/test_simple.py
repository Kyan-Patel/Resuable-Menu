...
class SimpleOrder(unittest.TestCase):
    ...
    def test_one(self):
        ...
        self.assertAlmostEqual(2.19, oOrderSystem.calcTotalCost(), 2)
    ...
    def test_two(self):
        ...
        self.assertAlmostEqual(3.29, oOrderSystem.calcTotalCost(), 2)
    ...
    def test_three(self):
        ...
        self.assertAlmostEqual(4.39, oOrderSystem.calcTotalCost(), 2)
    ...
    def test_four(self):
        ...
        self.assertAlmostEqual(5.49, oOrderSystem.calcTotalCost(), 2)
